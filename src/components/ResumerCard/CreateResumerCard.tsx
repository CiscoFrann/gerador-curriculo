...
export default function CreateResumeCard() {
  return (
    <button className="group bg-white rounded-3xl p-8 border-2 border-dashed border-slate-300 shadow-sm flex flex-col items-center justify-center text-center gap-6 h-105 transition-all hover:border-solid hover:bg-slate-50 hover:scale-102 cursor-pointer ">
