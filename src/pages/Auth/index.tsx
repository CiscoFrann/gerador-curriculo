function Auth() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="hiden md:flex md:w-1/2 lg:w-[60%] bg-[#012169]  flex-col justify-center p-12 pr-15 items-start gap-8">
        ...
        <p className="text-[#82A0F5] text-2xl ">
          Projete seu futuro com ferramentas de design editorial que transforma
          sua trajetória em uma narrativa de autoridade.
        </p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-12">
        <div className="w-full max-w-md flex flex-col gap-8">
          <div className="bg-[#E6E6EB] p-1.5 rounded-2xl flex shadow-sm self-center">
            ...
            <button className="flex-1 py-4 px-8 m-1 rounded-xl font-bold hover:scale-105 cursor-pointer transition text-gray-500">
              Criar Conta
            </button>
          </div>
